...
function shownotes() {
    ...
    notesObj.forEach(function (element, index) {
            ...
            <div class=" card-body">
                ...
                <p class="card-text">Leave Type : <b>${element.Cars}</b></p>
                <button id= '${index}' onclick = "deleteNote(this.id)" class="cancel">Cancel Leave</button>
            </div>
        </div> `;
    })
    ...
    notesElm.innerHTML = `<div style="color:#EEF1FF; " class = "not">Not Finding any Notes! Add Notes</div>`
    }
}
